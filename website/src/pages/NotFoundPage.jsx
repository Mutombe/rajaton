    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden mesh-hero noise">
      ...
      <div className="ctn py-32 relative z-10 text-center">
        <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <h1 className="text-3xl md:text-6xl font-extrabold text-fg -mt-8 md:-mt-14  tracking-tight">
            Page Not <span className="text-gradient">Found</span>
          </h1>
          <p className="text-fg-3 text-base mt-6 max-w-sm mx-auto">The page you're looking for doesn't exist or has been moved.</p>
